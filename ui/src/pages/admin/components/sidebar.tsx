  ...
  return (
    <div className={`h-full bg-white border-r border-gray-200 transition-all duration-300 relative dark:bg-gray-800 dark:border-gray-700
      ...
      <nav className="pt-4 relative h-full">
        ...
        {/* GitHub & Version Info */}
        <div className={`absolute bottom-4 left-4 right-4 ${expanded ? 'px-0' : 'px-0 flex justify-center'}`}>
          <a
            href="https://github.com/banjuer/nav"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white group"
            title="GitHub"
          >
            ...
            {expanded && (
              <div className="ml-2 flex flex-col text-[10px] leading-tight">
